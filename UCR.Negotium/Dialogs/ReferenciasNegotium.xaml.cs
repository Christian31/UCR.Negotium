...
namespace UCR.Negotium.Dialogs
{
    ...
    public partial class ReferenciasNegotium : MetroWindow
    {
        public ReferenciasNegotium()
        {
            ...
            referenciasList.Items.Add("Ministerio de Planificación Nacional y Política Económica. (2010) Guía metodógica general para la identificación, formulación y evaluación de proyectos de inversión pública. San José, Costa Rica: MIDEPLAN.");
